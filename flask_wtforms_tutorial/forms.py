...
class StockForm(FlaskForm):
    """Generate Your Graph."""
    r = requests.get("https://pkgstore.datahub.io/core/nyse-other-listings/nyse-listed_json/data/e8ad01974d4110e790b227dc1541b193/nyse-listed_json.json")
    stocksJSON = r.json()
    stocks = [("IBM", "IBM"),
            ("GOOGL", "GOOGL")]
    for stock in stocksJSON: 
      stocks.append((stock["ACT Symbol"], stock["ACT Symbol"]))
